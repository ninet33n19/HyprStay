/*
  ...
  - You are about to drop the column `availability` on the `bookings` table. All the data in the column will be lost.
  - Added the required column `isBooked` to the `bookings` table without a default value. This is not possible if the table is not empty.
